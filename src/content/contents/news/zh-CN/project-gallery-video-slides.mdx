---
title: "项目画廊中的视频幻灯片——播放前零字节占用"
description: "项目轮播图现在可以在图片旁边添加自托管视频幻灯片。以下是使用方法、工作原理，以及为什么它不会消耗任何 Lighthouse 分数。"
...
locale: zh-CN
uid: "video-slides"
image: "../../../../assets/news/project-gallery-video-slides.svg"
