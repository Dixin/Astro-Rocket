---
title: "Astro Rocket 入门指南 — 从安装到上线只需几分钟"
description: "如何安装、配置和部署 Astro Rocket — 涵盖 site.config.ts、品牌色彩、导航、撰写文章和部署到 Vercel。"
...
```bash
git clone https://github.com/Dixin/astro-rocket my-site
cd my-site
pnpm install
pnpm dev
```
...
If Astro Rocket saved you time, a [star on GitHub](https://github.com/Dixin/astro-rocket) helps other developers find it. Takes two seconds.
