---
title: "在你的文章中嵌入 YouTube —— 点击后播放的嵌入组件"
description: "只需一个组件，即可在任意文章或页面中嵌入 YouTube 视频。页面初始仅加载缩略图；读者点击播放后，播放器才会从 youtube-nocookie.com 加载。Lighthouse 评分保持 100。"
...
locale: zh-CN
uid: "youtube-embeds"
image: "../../../../assets/news/youtube-embeds.svg"
...
And project galleries accept video slides natively — how those work is covered in the <ContentLink uid="news/video-slides">video slides post</ContentLink>.
