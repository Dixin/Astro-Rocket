...
If you'd like to see the rest of what the theme includes, browse the [other feature posts](https://astrorocket.dev/blog) or grab the theme on [GitHub](https://github.com/Dixin/astro-rocket).
