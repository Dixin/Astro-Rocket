...
```bash
git remote add upstream https://github.com/Dixin/astro-rocket.git
```
...
Every release is documented in [CHANGELOG.md](https://github.com/Dixin/astro-rocket/blob/main/CHANGELOG.md). It's worth two minutes before you start, so nothing surprises you.
...
If you hit a conflict you're unsure about, open an [issue on GitHub](https://github.com/Dixin/astro-rocket/issues) with the file name and what it says — happy to help you work it out.
