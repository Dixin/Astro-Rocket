...
description: "Astro Rocket now supports Umami out of the box — private, cookieless web analytics. Set one environment variable and you get real visitor numbers with no cookie banner."
