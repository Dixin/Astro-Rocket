...
description: "Astro Rocket is installed with git clone, so updating is a git merge — not an npm install and not manual file replacement. Here's the safe, reversible way to do it."
...
This is the question I get asked most often by people running [Astro Rocket](https://astrorocket.dev): *a new version is out — how do I update without losing everything I've written?*
