...
description: "Astro Rocket ships a newsletter signup that posts to a Resend audience. Set two environment variables, flip one switch, and the form appears on your blog index and under every post."
...
![The follow-along section on a phone: the field and the Subscribe button stacked full width beneath the RSS and social links](../../../assets/blog/newsletter-follow-along-phone.png)

On a desktop the same section is the LetterGlitch band, and the form sits inside the glass card:

![The follow-along section on desktop in dark mode: the signup inside the LetterGlitch glass card](../../../assets/blog/newsletter-follow-along-dark.png)
